...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" queryBinding="xslt2">
    ...
    <let name="si" value="doc('../XML-and-Schematron/SI-Amadis.xml')//@xml:id"/>
    <let name="siFile" value="doc('../XML-and-Schematron/SI-Amadis.xml')"/>
    
    <let name="M_ids" value="doc('../XML-and-Schematron/Montalvo_Amadis_1547_20.xml')//@xml:id"/>
    <let name="M_file" value="doc('../XML-and-Schematron/Montalvo_Amadis_1547_20.xml')"/>
